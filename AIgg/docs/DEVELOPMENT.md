...
.\AIgg.cmd tests        # auto-diagnostics (134 vérifications, PASS/FAIL réels)
...
library <sous-commande> email <sous-commande> gmail <sous-commande> vault <sous-commande> docs-check`.
