...
.\AIgg.cmd tests        # auto-diagnostics (254 vérifications, PASS/FAIL réels)
...
library <sous-commande> email <sous-commande> gmail <sous-commande> vault <sous-commande> appearance <sous-commande> conscience <sous-commande> relations <sous-commande> interests <sous-commande> docs-check`.
